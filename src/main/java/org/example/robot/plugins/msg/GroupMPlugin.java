 ...
 **/
@Slf4j
public class GroupMPlugin extends MessagePluginImpl {
    ...
    public void initPluginData(Map<String, Object> config) {
        ...
        if(banRuleItems instanceof Map) {
            ...
            if (items != null)
                GroupMPlugin.banRuleItems.putAll(items);
        }
    ...
    public void viewRuleItem(){
        ...
        for (int i = 0; i < banRuleItems.size(); i++) {
            msg.append(i).append(". ").append(banRuleItems.get(i)).append("\n");
        }
